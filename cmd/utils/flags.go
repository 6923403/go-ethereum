...
import (
	...
	"github.com/vcvvvc/go-ethereum/common/fdlimit"
	"github.com/vcvvvc/go-ethereum/consensus"
	"github.com/vcvvvc/go-ethereum/consensus/clique"
	...
	"github.com/vcvvvc/go-ethereum/p2p/netutil"
...
func SetShhConfig(ctx *cli.Context, stack *node.Node) {
	if ctx.GlobalIsSet(WhisperEnabledFlag.Name) ||
		...
		log.Warn("Whisper support has been deprecated and the code has been moved to github.com/vcvvvc/whisper")
	}
}
